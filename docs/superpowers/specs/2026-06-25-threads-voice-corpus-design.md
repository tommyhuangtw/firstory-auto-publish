...
| ③ | 故事庫 (Story Bank) | 從貼文抽出的個人小故事/案例(見下方判定標準),打主題標籤 | LLM 抽取 + 人釘選/刪 | 寫到相關主題時撈一則 |
...
### 故事庫判定標準(③ extractStories 的依據)
「個人小故事/案例」= 帶有 Tommy 第一人稱親身經歷的內容,主要涵蓋:
- **AI 接案心得**(接案過程、與客戶互動、踩雷/成功案例)
- **企業 AI 導入心得**(導入專案、企業端觀察)
- **職場心得**
- **英國生活心得**
- **美國 / 學校(求學)經歷**

判定要點:有「具體情境 + 個人經歷/觀點」才算故事;純資訊轉述、工具介紹、純宣傳不算。每則打上 `topic_tags`(如 `ai-freelance`, `enterprise-adoption`, `workplace`, `uk-life`, `us-school`)。

### 內容重心(channel 主軸)
頻道**最主要的內容是 AI 接案 + 企業 AI 導入**。風格檔(②)與故事庫(③)應**優先突顯**這兩類;之後寫手(下個 spec)在缺乏明確主題時也應預設偏向這兩條主軸。其餘(職場/英國/美國/求學)是豐富個人色彩的輔助素材。
...
- ~~**故事「定義」**~~:✅ 已敲定(見第 4 節「故事庫判定標準」與「內容重心」)。首批產出後仍人工校準。
