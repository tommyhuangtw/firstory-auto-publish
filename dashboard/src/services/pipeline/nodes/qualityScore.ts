...
（開場後應有 3-6 句內容預覽，讓聽眾知道這集會講什麼，然後直接切入主體內容。不可超過一段太長的鋪陳！）
...
1. 聊天感與語氣自然度（25 分）
   ...
   ✅ 加分指標：語句流暢、節奏自然，有轉折詞或口語連接詞；偶爾加入聽眾互動語氣；句型有高低起伏、情緒表現適當；少量使用自然口語節奏的語助詞（「啦」「吧」「嘛」等）；描述常見場景引發共鳴（如「書籤存了一堆根本沒回去看」）
   ❌ 扣分指標：長句過多或語法複雜，如報告式、論文式敘述；重複使用單一口氣（如全篇都是「這個工具可以...」「這個工具也可以...」）；沒有情緒語助詞，全篇聽感平淡；語助詞使用位置不合理（如用在資訊量重、理性說明的段落）；句尾語助詞機械性過度使用（「啦」「喔」「啊」「嘛」），導致語感拖沓、尷尬、不真實
...
開場必須為固定格式：
"每天都有一堆新的AI工具冒出來，是不是常常不知道該從哪裡開始？別擔心，這裡是AI懶人報，每天幫你精選五個最多人討論的AI工具影片，每天十分鐘，讓AI走進你的日常生活，讓你不知不覺成為效率大師。"
（開場後請用 3-6 句話簡短預覽今天的重點主題，讓聽眾知道這集會講什麼，然後直接切入主體內容！）
...
（開場後應有 3-6 句內容預覽，讓聽眾知道這集會講什麼，然後直接切入主體內容。不可超過一段太長的鋪陳！）`,
      `開場必須為固定格式：
${fixedOpening}
（句子的細部語序可自然些微調整，但整體概念要一致。開場後應有 3-6 句內容預覽，讓聽眾知道這集會講什麼，然後直接切入主體內容！）`
    );
...
1. 聊天感與語氣自然度（20 分）
   ...
   ✅ 加分指標：語句流暢、節奏自然，有轉折詞或口語連接詞；偶爾加入聽眾互動語氣；句型有高低起伏、情緒表現適當；少量使用自然口語節奏的語助詞（「啦」「吧」「嘛」等）；描述常見場景引發共鳴（如「書籤存了一堆根本沒回去看」）
   ❌ 扣分指標：長句過多或語法複雜，如報告式、論文式敘述；重複使用單一口氣（如全篇都是「這個工具可以...」「這個工具也可以...」）；沒有情緒語助詞，全篇聽感平淡；語助詞使用位置不合理或機械性過度使用
...
（開場後請用 3-6 句話簡短預覽今天的重點主題，讓聽眾知道這集會講什麼，然後直接切入主體內容！）`,
      `開場必須為固定格式：
${fixedOpening}
（此開場為固定文案，請完整保留概念，不要修改。開場後請用 3-6 句話簡短預覽今天的重點主題，讓聽眾知道這集會講什麼，然後直接切入主體內容！）`
    )
    .replace(
      `結尾段落需流暢的包涵導流句，評分邀請，明天再繼續收聽的提醒句～
接近結尾處必須有導流句與評分邀請：
