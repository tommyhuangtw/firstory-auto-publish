...
const DEFAULTS = {
  ...
  resource_github_created_days: '60',    // 只撈最近兩個月「建立」的新 repo（created:>），不是最後 commit 日
  resource_github_min_stars: '80',
  // 依建立年齡分級的爆衝門檻：新生 repo 的總星數≈該時間窗衝到的星數。任一窗達標即挑出。
  resource_github_burst_3d_stars: '1500',     // ≤ 3 天建立 且 ≥ 此星數
  resource_github_burst_1w_stars: '2500',     // ≤ 7 天建立 且 ≥ 此星數
  resource_github_burst_2w_stars: '5000',     // ≤ 14 天建立 且 ≥ 此星數
  resource_github_burst_1m_stars: '10000',    // ≤ 30 天建立 且 ≥ 此星數
  resource_github_burst_2m_stars: '20000',    // ≤ 60 天建立 且 ≥ 此星數
  resource_top_n: '5',
