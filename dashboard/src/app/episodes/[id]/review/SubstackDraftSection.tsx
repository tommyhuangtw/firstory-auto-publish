      ...
      {draft && (
        <div className="px-4 pb-4 space-y-3 border-t border-zinc-800 pt-3">
          ...
          <details open>
            ...
            <div
              ref={previewRef}
              className="mt-2 border border-zinc-800 rounded-lg p-3 text-sm text-zinc-300 leading-relaxed [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-zinc-100 [&_h2]:mt-3 [&_a]:text-violet-400 [&_ul]:list-disc [&_ul]:pl-5 [&_p]:my-2 [&_img]:rounded-lg [&_img]:mt-3 [&_img]:mb-1 [&_img]:w-full [&_em]:text-[10px] [&_em]:text-zinc-600"
            >
